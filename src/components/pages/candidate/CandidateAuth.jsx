...
const CandidateAuth = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isLogin) {
      // Static login check
      if (
        formData.email === "dhanashribhamare977@gmail.com" &&
        formData.password === "admin@1234"
      ) {
        alert("Login successful!");
        navigate("/candidate-dashboard"); // redirect after login
      } else {
        ...
        <div className="form-container">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            >
              ...
              <FiArrowRight
                className={`btn-arrow ${isHovered ? "animate" : ""}`}
              />
            </button>
          </form>
          ...
          <div className="social-login">
            <button className="social-btn google" type="button">
              <svg className="social-icon" viewBox="0 0 24 24">
                <path
                  fill="#DB4437"
                  d="M12.5 10.5v4h6.5c-0.4 2-2.3 6-6.5 6-4 0-7-3-7-7s3-7 7-7c2 0 3.4 1 4.5 2l3-3c-2-2-4.5-3-7.5-3-5.5 0-10 4.5-10 10s4.5 10 10 10c8 0 10-7 10-10 0-1-0.1-1.5-0.3-2h-9.7z"
                />
              </svg>
              Google
            </button>
